...
function useInvestmentSimulation({ binanceWallet = null, isConnected = false } = {}) {
    ...
    const generateRandomProject = ()=>{
        ...
        const initialPrice = settings.investmentAmount;
        return {
            name: randomName,
    ...
    const simulateTrading = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useInvestmentSimulation.useCallback[simulateTrading]": async ()=>{
            if (!isConnected || !binanceWallet) {
                if (portfolio.totalCapital < settings.investmentAmount) {
                    setIsSimulating(false);
                    return;
                }
            } else if (binanceWallet.availableBalance < settings.investmentAmount) {
                setIsSimulating(false);
                return;
            }
            setIsLoading(true);
            ...
            try {
                ...
                if (isConnected && binanceWallet) {
                    binanceWallet.lockFunds(settings.investmentAmount);
                }
                ...
                addTrade({
                    ...
                    result: -settings.investmentAmount
                });
            } catch (error) {
            ...
            const simulatePrice = {
                "useInvestmentSimulation.useCallback[simulateTrading].simulatePrice": async ()=>{
                    ...
                    const stopLossPrice = project.initialPrice * (1 - settings.stopLoss / 100);
                    const trailingStopPrice = project.initialPrice * (1 + settings.trailingStop / 100);
                    if (project.price <= stopLossPrice) {
                        const loss = -(settings.investmentAmount * (settings.stopLoss / 100));
                        if (isConnected && binanceWallet) {
                            binanceWallet.unlockFunds(settings.investmentAmount, loss);
                        }
                        addTrade({
                            type: 'STOP_LOSS',
                            project: project.name,
                    ...
                    if (project.price >= trailingStopPrice) {
                        const profit = settings.investmentAmount * (settings.trailingStop / 100);
                        if (isConnected && binanceWallet) {
                            binanceWallet.unlockFunds(settings.investmentAmount, profit);
                        }
                        addTrade({
                            type: 'TRAILING_STOP',
                            project: project.name,
                    ...
                    setPortfolio({
                        "useInvestmentSimulation.useCallback[simulateTrading].simulatePrice": (prev)=>({
                                ...
                                chartData: [
                                    ...
                                    {
                                        name: new Date().toLocaleTimeString(),
                                        value: prev.totalCapital + (project.price - settings.investmentAmount)
                                    }
                                ]
                            })
                    }["useInvestmentSimulation.useCallback[simulateTrading].simulatePrice"]);
            ...
            if (attempts >= maxAttempts) {
                ...
                const profit = settings.investmentAmount * (settings.trailingStop / 200); // Half of trailing stop
                if (isConnected && binanceWallet) {
                    binanceWallet.unlockFunds(settings.investmentAmount, profit);
                }
                addTrade({
    ...
    const startSimulation = ()=>{
        if (isConnected && binanceWallet) {
            if (binanceWallet.availableBalance < settings.investmentAmount) {
...
_s(useInvestmentSimulation, "yGO9e4i7jj6bsYMNo3NNfXT9yzA=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
"[project]/src/components/InvestmentSettings.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
function InvestmentSettings({ onUpdate, disabled }) {
    _s();
    const [investmentAmount, setInvestmentAmount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(50);
    const [stopLoss, setStopLoss] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(50);
    const [trailingStop, setTrailingStop] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(200);
    ...
    const handleTrailingStopChange = (value)=>{
        setTrailingStop(value[0]);
    };
    const handleApply = ()=>{
        onUpdate({
            investmentAmount,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                ...
                children: "Configurações de Investimento"
            }, void 0, false, {
                fileName: "[project]/src/components/InvestmentSettings.tsx",
                lineNumber: 45,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: "Valor mínimo: $5 | Valor máximo: $100"
                            }, void 0, false, {
                                fileName: "[project]/src/components/InvestmentSettings.tsx",
                                lineNumber: 61,
                                columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-xs text-zinc-500",
                                children: "Porcentagem de perda máxima permitida"
                            }, void 0, false, {
                                fileName: "[project]/src/components/InvestmentSettings.tsx",
                                lineNumber: 79,
                                columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$slider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Slider"], {
                                ...
                                onValueChange: handleTrailingStopChange,
                                disabled: disabled,
                                className: "w-full"
                            }, void 0, false, {
                                fileName: "[project]/src/components/InvestmentSettings.tsx",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-xs text-zinc-500",
                                children: "Ajuste do stop loss após atingir este percentual de lucro"
                            }, void 0, false, {
                                fileName: "[project]/src/components/InvestmentSettings.tsx",
                                lineNumber: 97,
                                columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                        ...
                        onClick: handleApply,
                        disabled: disabled,
                        children: "Aplicar Configurações"
                    }, void 0, false, {
                        fileName: "[project]/src/components/InvestmentSettings.tsx",
                        lineNumber: 102,
                        columnNumber: 9
...
_s(InvestmentSettings, "b0a1IhZW6gjq2O3Gcxab8mIkm+A=");
_c = InvestmentSettings;
var _c;
__turbopack_context__.k.register(_c, "InvestmentSettings");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$InvestmentSettings$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/InvestmentSettings.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function Home() {
    ...
    const { portfolio, isSimulating, isLoading, settings, setSettings, startSimulation, stopSimulation, resetSimulation } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useInvestmentSimulation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useInvestmentSimulation"])({
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: [
                                "Simulação de investimento com $",
                                settings.investmentAmount,
                                " por projeto Alpha, Stop Loss de ",
                                settings.stopLoss,
                                "%, Trailing Stop ajustado a cada ",
                                settings.trailingStop,
                                "% de valorização. Capital total: $1.000"
                            ]
                        }, void 0, true, {
                            fileName: "[project]/src/app/page.tsx",
                            lineNumber: 61,
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$InvestmentSettings$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InvestmentSettings"], {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: [
                                        "Capital inicial: $1,000.00 | Valor por entrada: $",
                                        settings.investmentAmount
                                    ]
                                }, void 0, true, {
                                    fileName: "[project]/src/app/page.tsx",
...
_s(Home, "KGPsutIzldipxOoxvWnwNWFlIh4=", false, function() {
    return [
...
//# sourceMappingURL=src_744f9851._.js.map